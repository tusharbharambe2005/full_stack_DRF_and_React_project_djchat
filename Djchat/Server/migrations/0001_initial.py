    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.FileField(blank=True, null=True, upload_to=Server.models.category_icon_upload_path, validators=[Server.validator.validate_icon_image_size, Server.validator.valid_image_file_exstension])),
            ],
        ),
        migrations.CreateModel(
            name='Server',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banner', models.ImageField(blank=True, null=True, upload_to=Server.models.Channel_banner_upload_path, validators=[Server.validator.valid_image_file_exstension])),
                ('icon', models.ImageField(blank=True, null=True, upload_to=Server.models.Channel_icon_uplpad_path, validators=[Server.validator.validate_icon_image_size, Server.validator.valid_image_file_exstension])),
